'use strict';
/* Shadow Ascension · Arise presentation v0.3 + visual pass loader */
(function(){
 ...
 function loadPasses(){
  const names=['phaser-boss-telegraph.js?v=0.1.0','phaser-arena-atmosphere.js?v=0.1.0','phaser-vitals.js?v=0.1.0','phaser-mobile-polish.js?v=0.1.0','phaser-combat-impact.js?v=0.1.0','phaser-portal-fx.js?v=0.1.0'];
  names.forEach(src=>import('./'+src).catch(e=>console.warn('[shadow] visual pass failed',src,e)));
 }
